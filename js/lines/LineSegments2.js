THREE.LineSegments2 = function (geometry, material) {
  ...
  if (material === undefined)
    material = new THREE.LineMaterial({ color: Math.random() * 0xffffff });
...
THREE.LineSegments2.prototype = Object.assign(Object.create(THREE.Mesh.prototype), {
  ...
  raycast: (function () {
    ...
    var getWorldSpaceHalfWidth = (function () {
      const _clipToWorldVector = new THREE.Vector4();

      return function (camera, distance, resolution) {
    ...
    var raycastScreenSpace = (function () {
      ...
      return function (lineSegments, camera, intersects) {
